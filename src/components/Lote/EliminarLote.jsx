...
function EliminarLote({ onCancel, onDataUpdate }) {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://52.154.73.74/api.php?apicall=deletelote', {
      method: 'POST',
      headers: {
      ...
      .then(data => {
        if (data.error) {
          setMessage('Error al eliminar el lote');
        } else {
  ...
  return (
    <div className="Delete-container">
      <h2 className="text-2xl font-bold mb-4">Eliminar Lote</h2>
